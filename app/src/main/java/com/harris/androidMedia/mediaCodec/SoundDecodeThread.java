...
//         输出
        ...
        while (true) {
            ...
            if (!bIsEos) {
                int inIndex = mediaCodec.dequeueInputBuffer(TIMEOUT_USEC);
                if (inIndex >= 0) {
            ...
            int outIndex = mediaCodec.dequeueOutputBuffer(info, TIMEOUT_USEC);
            ...
            switch (outIndex) {
                ...
                default:
                    ...
                    Log.v(TAG, outIndex +" We can't use this buffer but render it due to the API limit, " + outputBuffer);
