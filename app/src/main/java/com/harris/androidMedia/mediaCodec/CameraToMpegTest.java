...
public class CameraToMpegTest  {
    ...
    private static final File OUTPUT_DIR = new File(Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+Environment.DIRECTORY_DOWNLOADS);
    ...
    private static class CameraToMpegWrapper implements Runnable {
        ...
        public static void runTest(CameraToMpegTest obj) throws Throwable {
            ...
            th.start();
//            th.join(); // https://stackoverflow.com/questions/22457623/surfacetextures-onframeavailable-method-always-called-too-late
            // comment this line out since it will block the main thread
