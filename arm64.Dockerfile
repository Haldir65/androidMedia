...
ENV JAVA_HOME=/usr/lib/jvm/temurin-$JAVA_VERSION-jdk-arm64
...
# RUN ${ANDROID_ROOT}/sdk/cmdline-tools/latest/bin/sdkmanager --help

RUN ${ANDROID_ROOT}/sdk/cmdline-tools/latest/bin/sdkmanager --licenses >/dev/null

# RUN yes | ${ANDROID_ROOT}/sdk/cmdline-tools/latest/bin/sdkmanager --licenses
