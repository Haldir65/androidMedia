...
import com.cgfay.filterlibrary.filter.OESInputFilter;
...
public class NativeRenderMain3Activity extends AppCompatActivity implements SurfaceHolder.Callback,
    ...
    private void onSurfaceCreated(SurfaceHolder holder) {
        ...
        mOESInputFilter = new OESInputFilter(NativeRenderMain3Activity.this);
