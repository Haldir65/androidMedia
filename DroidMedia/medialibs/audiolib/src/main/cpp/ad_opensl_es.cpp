...
Java_com_me_harris_audiolib_audioPlayer_ADOpenSLES_playAudio(JNIEnv *env, jobject thiz,
                                                             jstring path_, jint sample_rate,
                                                             jint ch_layout, jint format) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_me_harris_audiolib_audioPlayer_ADOpenSLES_stopAudio(JNIEnv *env, jobject thiz) {
    willexit = 1;
}
