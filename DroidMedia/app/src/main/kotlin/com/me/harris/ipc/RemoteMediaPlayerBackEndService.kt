...
//                player.setOnErrorListener()
    ...
    private fun logCurrentProcess(){
        Log.w("=A=","current process id = ${android.os.Process.myPid()} process Name = ${currentProcessName()}")
    }
    ...
    private fun currentProcessName():String {
        ...
        for (processInfo in this.getSystemService<ActivityManager>()!!.runningAppProcesses) {
