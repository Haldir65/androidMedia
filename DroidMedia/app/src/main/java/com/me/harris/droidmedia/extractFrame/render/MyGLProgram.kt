...
class MyGLProgram {
    ...
    init {
        val vertexShader: Int = ShaderUtil.loadShaderv2(GLES20.GL_VERTEX_SHADER, vertexShaderCode)
        val fragmentShader: Int = ShaderUtil.loadShaderv2(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode)
