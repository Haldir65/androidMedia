package com.me.harris.droidmedia.audiorecord
...
import com.me.harris.droidmedia.databinding.ActivityMediaCodecDecodeAacBinding
import com.me.harris.droidmedia.databinding.ActivityMediaCodecForAacBinding
...
class MediaCodecForAACActivity : AppCompatActivity() {
    ...
    private fun initAudioRecorder() {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.RECORD_AUDIO),1092)
            return
        }
    ...
    private fun mediaCodecEncodeToAACWithPermissionCheck() {
        if (ActivityCompat.checkSelfPermission(
                this,
                Manifest.permission.RECORD_AUDIO
            ) != PackageManager.PERMISSION_GRANTED
...
//                    codec.releaseOutputBuffer(index, false)
            ...
            e.message?.let { Log.e("mistake", it) }
        } finally {
//                fileWrite?.close()
//                mediaEncode.release()
        }
