package com.me.harris.droidmedia.extractFrame.render
...
//        val sy = 1f * imageHeight / height
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        val vertexSource =
            ShaderUtil.loadFromAssets("vertext_v2_yuv.glsl", context!!.getResources());
        val fragmentSource =
            ShaderUtil.loadFromAssets("fragment_v2_yuv.glsl", context!!.getResources())
    ...
    fun setYuvData(yuv: ByteArray?, width: Int, height: Int) {
        imageWidth = width
        imageHeight = height
        imageBytes = yuv!!
